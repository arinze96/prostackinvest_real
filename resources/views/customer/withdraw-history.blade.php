                            ...
                            <div class="nk-block-head">
                                ...
                                <div class="nk-block-between-md g-4">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title fw-normal">My Withdrawal History</h2>
                                        <div class="nk-block-des">
                                            <p>At a glance summary of your withdrawal history. Enjoy !</p>
                                        </div>
                                    </div>
                                    <div class="nk-block-head-content">
                            ...
                            <div class="nk-block">
                                <div class="row g-gs">
                                    <div class="col-md-12">
                                        ...
                                        @else
                                          <p class="text-center">No withdrawal Record Found</p>   
                                        @endif
