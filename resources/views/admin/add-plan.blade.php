                     ...
                     <div class="components-preview wide-md mx-auto">
                      <div class="nk-block-head nk-block-head-lg wide-sm">
                       <div class="nk-block-head-content">
                        ...
                        <h2 class="nk-block-title fw-normal">Add Investment Plan</h2>
                       </div>
                      </div><!-- .nk-block-head -->
                       ...
                       <div class="card card-bordered card-preview">
                        <div class="card-inner">
                         <div class="preview-block">
                          ...
                          <div class="">
                           <form class="" method="POST" data-post-type="edit-plan" action="{{ route("admin.add.plan.view") }}">
                            ...
                            <div class="col-sm-6 col-md-12 mb-2">
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                <input required="" type="text" name="min" class="form-control" id="min" placeholder="Enter Min" value="{{ old("min") }}">
                               </div>
                               @error('min')
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                <input required="" type="text" name="max" class="form-control" id="max" placeholder="Enter max" value="{{ old("max") }}">
                               </div>
                               @error('max')
                            ...
                            <div class="col-sm-4 mt-3">
                             <div class="form-group">
                              <div class="form-control-wrap">
                               <button type="submit"  name="add-plan" style="text-align:center;" class="d-block form-control btn btn-primary " >Add Investment Plan</button>
                              </div>
                             </div>
                            </div>
