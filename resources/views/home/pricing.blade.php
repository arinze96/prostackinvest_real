...
============================================= -->
   ...
   ============================================= -->
        ...
        <!-- Testimonial #1
============================================= -->
        <section id="testimonial1" class="testimonial testimonial-1 pt-70 pb-100 bg-gray">
            <div class="container">
                <div class="row">
                        ...
                        <div id="testimonial-wide" class="carousel owl-carousel" data-slide="1" data-slide-rs="1"
                            ...
                            <div class="testimonial-panel">
                                ...
                                <div class="testimonial--body">
                                    <div class="testimonial--icon2"></div><!-- .testimonial-icon end -->
                                    <p>Consultivo team ensure to provide best advice and products available in the whole
                                        market and we are efficient in our services. They keep an eye on provider's
                                        changes.</p>
                            ...
                            <div class="testimonial-panel">
                                ...
                                <div class="testimonial--body">
                                    <p>Highly recommended & a great experience. The process was simple and easy to
                                        understand. Trading was straight forward, supports all major needs.!</p>
                                </div><!-- .testimonial-body end -->
                                <div class="testimonial--icon2"></div><!-- .testimonial-icon end -->
                                <div class="testimonial--meta">
                            ...
                            <div class="testimonial-panel">
                                ...
                                <div class="testimonial--body">
                                    <p>Highly recommended & a great experience. The process was simple and easy to
                                        understand. Trading was straight forward, the entire process was super smooth!
                                    </p>
                                </div><!-- .testimonial-body end -->
                                <div class="testimonial--icon2"></div><!-- .testimonial-icon end -->
                                <div class="testimonial--meta">
