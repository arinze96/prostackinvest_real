                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                        <div class="title title-6 text-center">
                            ...
                            <ol class="breadcrumb d-flex justify-content-center">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('user.pages.view', ['about'])  }}">about</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <textarea class="form-control" name="contact-message" id="contact-message"
                                        rows="2" placeholder="Request Details:"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12  col-sm-12  col-md-12">
                        ...
                        <div id="googleMap" class="googleMap" data-map-address="121 King St,Melbourne, Australia"
                            data-map-zoom="12" data-map-maker-icon="assets/images/gmap/maker.png"
                            data-map-type="ROADMAP" data-map-info="Consultivo<br>info@7oroof.com"
