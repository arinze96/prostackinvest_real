...
<body>
    ...
    <div id="wrapper" class="wrapper clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Strategy & Planning</h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Audit & Evaluation</h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                <h3 class="feature-card-title">Taxes & Efficiency</h3>
        ...
        <section id="case" class="case case-gallery case-3col pb-60 bg-gray">
            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/1.jpg") }}" alt="case Item">
                                                    ...
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            ...
                                                            <div class="case--title">
                                                                <h4><a href="#">Use credit reporting to improve client
                                                                        relationships.</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/2.jpg") }}" alt="case Item">
                                                <div class="case--hover">
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            <div class="case--cat">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/3.jpg") }}" alt="case Item">
                                                <div class="case--hover">
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            <div class="case--cat">
                                                                <a href="#">Customer Service</a><a
                                                                    href="#">Consulting</a>
                                                            </div>
                                                            <div class="case--title">
                                                                <h4><a href="#">State stamp duty surcharges for foreign
                                                                        buyers.</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/4.jpg") }}" alt="case Item">
                                                <div class="case--hover">
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            <div class="case--cat">
                                                            ...
                                                            <div class="case--title">
                                                                <h4><a href="#">Government changes on transfer of land
                                                                        or duty. </a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/5.jpg") }}" alt="case Item">
                                                <div class="case--hover">
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            <div class="case--cat">
                                                                <a href="#">Business Growth</a><a
                                                                    href="#">Investment</a>
                                                            </div>
                                                            <div class="case--title">
                                                                <h4><a href="#">How to explain the ASIC inquiry to
                                                                        clients!</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 case-item">
                                        <div class="case-item-container">
                                            <div class="case--img">
                                                <img src="{{ asset("assets/images/case/3col/6.jpg") }}" alt="case Item">
                                                <div class="case--hover">
                                                    <div class="case--action">
                                                        <div class="case--content">
                                                            <div class="case--cat">
                                                            ...
                                                            <div class="case--title">
                                                                <h4><a href="#">How blockchain technology will impact
                                                                        the broking?</a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
