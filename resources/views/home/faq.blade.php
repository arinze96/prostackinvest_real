                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                        <div class="title  text-center">
                            ...
                            <ol class="breadcrumb d-flex justify-content-center">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('user.pages.view', ['faq'])  }}">FAQs</a></li>
